...
public class ApplicationConfigurationValidator extends ConfigurationValidator {
  ...
  public ValidationResult validate() {
    ...
    ValidationResult transmissionRiskResult =
        new TransmissionRiskConfigurationValidator(config.getTransmissionRiskConfig()).validate();

    return errors.with(exposureResult).with(riskScoreResult).with(transmissionRiskResult);
  }
